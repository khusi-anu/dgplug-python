...
[13:44] <gnovi> This is a special moment. 10th edition of life changing learning experiences by dgplug
...
[13:45] <kushal> There are a few known short forms, but try to type all the words in full spelling.
[13:45] <abdulwahababrar> done registering nickname
[13:46] <tnsittpsif> kushal: Hello! Good evening
[13:46] <singh123> I have also done.
[13:46] <kushal> During a session, if you have a question, type ! and then wait for the moment when batul tells you to ask the question.
[13:47] <kushal> As you all know, this is a completely free training, that also means if you don't word hard and come up with questions or things you did not manage to learn, we may not be able to help you out.
[13:47] <sayan> !
[13:47] <kushal> next
...
[13:48] <bhavin192> !
[13:48] <kushal> Wait for some time till I tell you to start asking all the questions you have :)
[13:49] <kushal> If you are using xchat or hexchat, you should be able to see some nicks with green dots in front of them, they are the channel operators.
[13:49] <jiteshpabla> !
[13:49] <kvy_> kushal : +1
...
[13:49] <kushal> next
[13:50] <kushal> next
[13:50] <abdulwahababrar> I may miss first 1 hour of this session due to coming from college and other things, Is it possible to read the messages later!?
...
[13:50] <ashwanig> !
[13:51] <singh123> !
[13:51] <sayan> apoorv: <eof> or <eom> tells the person who is taking the session that you have asked the complete question
[13:52] <abhinavshirur[m]> sayan: +1
[13:52] <_bhargav> Hey guys, sorry I'm a little late. Any logs I can read through to catch up?
[13:52] <apoorv> Okay
[13:52] <sayan> it might sometimes happen that you need to ask your question in multiple lines, so then it proves to be useful
...
[13:54] <jiteshpabla> how to catch up on chats if you are late, or if you miss a session?<eof>
...
[13:54] <sayan> jiteshpabla: better to come online and ask someone for the log, ask what happened
[13:54] <neer> just getting used to this <eof>
[13:54] <kushal> :)
[13:55] <kushal> next
[13:55] <ashwanig> I saw that the ircbot is written in Go. Is there also a python version of it? <eof>
...
[13:55] <santoshShaw[m]> !
[13:55] <kushal> singh123, we will mostly discuss about the format of the sessions and few first steps.
[13:55] <ravindra> !
[13:55] <kushal> next
...
[13:57] <kushal> dodococo, for the first days yes, then 3 days in a week, and the guest sessions can happen anytime
[13:57] <kushal> next
[13:57] <im_mohsin> what is <eof>?
[13:57] <sayan> dodococo: session will be announced at the end of each session, we usually do it alternate days
[13:57] <kushal> im_mohsin, type that in google.com
[13:57] <kushal> next
[13:57] <jiteshpabla> !
[13:57] <santoshShaw[m]> Apart from Python. Will we contribute to projects using C or C++?<rog>
[13:57] <kushal> santoshShaw[m], you are free to contribute to a project written in any language
[13:57] <apoorv> !
[13:58] <kushal> next
[13:58] <sayan> next
...
[13:58] <geekodour08> !
[13:58] <singh123> If i ask question and my doubt didnot get clear,then we have to wait for another term?
[13:59] <kushal> ravindra, Ubuntu will do, we prefer Fedora, during the sessions you will learn why.
[13:59] <kushal> singh123, nope, say that, and ask again the next doubt
[13:59] <kushal> next
[13:59] <kushal> next
[13:59] <Padfoot7> !
[13:59] <sharan> !
[13:59] <jiteshpabla> except for the irc, what other ways will we be communicating through, if any? <eof>
[13:59] <kushal> jiteshpabla, Mailing list
[13:59] <kushal> next
[13:59] <sayan> jiteshpabla: IRC & Mailing List
[13:59] <bhawana> hey!! i wanted to ask that we have to came to irc at same time every day to get the update or we will get the information through mail also..
[14:00] <ashwanig> !
...
[14:03] <kushal> Few reasons, most of the upstream open source projects or developers do talk on IRC, it takes very less bandwidth, and works even on 2G.
...
[14:05] <Pavan> !
[14:05] <sayan> next
[14:05] <kushal> At the end,  generally it is the same group of people who stays late on IRC and also get a lot of things done, and also become better upstream developers.
[14:05] <kushal> Because you will have to spend time to learn things.
[14:05] <ndakota> If someone asks a question, are there a set of people nominated to answer or can anyone answer?<eof>
...
[14:06] <kushal> Pavan, maybe no mails from the time you joined, wait for the end of the sessions.
...
[14:07] <saikat195> Are we supposed to receive any mails in the mailing list? I have applied for subscription, but received any verification
[14:07] <bhavin192> !
...
[14:08] <abdulwahababrar> kushal, If you allow me. Can I tell how to register nickname please
...
[14:10] <kushal> next
[14:10] <geekodour08> do I have to register somewhere, i filled the google form. is there any verification mail that i should get?
[14:10] <fhackdroid> kushal: 182 nicks in the channel XD
[14:10] <kushal> fhackdroid, I see only 149
[14:11] <kushal> Everyone: you have to register your IRC nickname to the freenode server, see this http://www.wikihow.com/Register-a-Nickname-on-Freenode
...
[14:11] <sayan> As kushal told, if you are using xchat or HexChat you might see green dots beside few of the nicknames
...
[14:13] <sayan> Also, during the session if the channel needs to go into full attention mode, then the op can mute the channel
...
[14:13] <sayan> I will explain these with an example. kushal asked a few times not to use ! but few people did continue even after that
...
[14:14] <sayan> so in that case the the op can mute the channel, and nobody can speak other that the ops
...
[14:19] <kushal> everyday at the beginning of the sessions and at the end, we will say roll call
...
[14:25] <saikat195> !
[14:25] <kushal> next
[14:25] <ashwanig> Hello, I am Ashwani Kumar Gupta. I am a junior year CS undergraduate student from Academy of Technology.
...
[14:26] <akshayg96[m]> !
[14:27] <kushal> next
[14:27] <bhavin192> I am Bhavin Gandhi, I'm last year BTech CSE student from RIT, Islampur <eof>
[14:27] <kushal> next
[14:27] <proishan11__> !
[14:27] <sharan_> !
[14:27] <kushal> next
[14:27] <tnsittpsif> Hello! I am Harshit Doshi from Rajkot, Gujarat but studying in Bangalore. I am a 2nd year CSE Student at Christ University.
[14:27] <dhanesh95> I'm Dhanesh B. Sabane. I've been a Fedora contributor since November 2015. Currently I'm working as a Software Engineer at a startup in Pune. I'm also a Mozilla contributor and a wannabe Debian contributor. <eof>
...
[14:30] <kushal> next
[14:30] <im_mohsin> Hello, i'm Mohsin Mumtaz, studying MCA 2years at M.S.Ramaiah Institute Of Technology, Bangalore <eom>
...
[14:31] <kushal> next
[14:31] <abhinavshirur[m]> Hello everyone, I am Abhinav Shirur, pursuing Information Technology in Walchand College of Engineering Sangli :) <eof>
[14:31] <kushal> next.
[14:31] <kushal> next
[14:31] <kushal> next
...
[14:31] <sitlanigaurav[m]> Hello #dgplug I'm Gaurav Sitlani , Final year comp science student from SCOE, Pune and a FOSS enthusiast. Worked on projects using python with startups.
[14:31] <avik> <eof>
...
[14:32] <kushal> next
[14:33] <dhairyya> Hello, I am Dhairyya Agarwal. I am 3rd year CSE undergraduate in Institute Of Engineering & Management, Kolkata<eof>
[14:33] <kushal> next
[14:33] <anuGupta> Myself anu kumari gupta, 2nd year Computer science and engineering student at academy of technology, west bengal. I am learning Python nowadays<eof>
[14:33] <kushal> dhairyya, you spoke early.
[14:33] <dhairyya> I am sorry <eof>
[14:33] <neer> !
[14:33] <sayan> next
[14:33] <kushal> Hello everyone, I am Kushal Das, part of dgplug, I will also learn along the way with all of you.
[14:33] <RatanShreshtha> Hello, I am Ratan Kulshreshtha, I am currently working in Reliance Jio <eof>
...
[14:35] <kushal> next
[14:35] <kushal> next
[14:35] <cran-cg> Hello everyone I am Chiranjeev Gupta, a recent graduate from Zakir Husain College Of Engineeering And Technology, Aligarh Muslim University. I am here to learn and thus contribute better to the open source society
...
[14:35] <skarpy> Hello, I am Akash Pathak, 3rd year, ECE, D.r. BC Roy engineering college,   I am from durgapur. :) <eof>
[14:35] <kushal> * now
[14:35] <bhavin192> geekodour08, name
[14:35] <bhavin192> ?
[14:35] <kushal> next
[14:36] <shivamA1> I am Shivam Ahirao, last year BE (IT) student from NBN sinhgad institutes, vadgaon,pune, i am an active attendie of python pune meetup group  .
[14:36] <kushal> next
[14:36] <geekodour08> bhavin192: Hrishikesh Barman
[14:36] <kushal> next
[14:36] <santoshShaw[m]> Santosh Shaw . a CSE 3rd year @Academy of technology. Have a lot of passion towards programming . C is my favorite and I early look forward to contribute to open source.<eof>
[14:36] <kushal> next
...
[14:36] <kushal> next
[14:36] <RJ722> Hello, I am Rahul Jha! I am a freshman year Electronics Engineering Student at Zakir Hussain College of Engineering and Technology.
[14:36] <RJ722> I have been selected with coala for Google Summer of Code this year <eof>
[14:36] <saikat195> I am Saikat Dey, student, pusuing B.Tech CSE Freshman Year. Willing to learn, and contribute to FOSS.
[14:37] <kushal> next
[14:37] <kushal> next
[14:37] <apoorv> Hi, I am Apoorv Goel, I am a 2nd year btech student of computer science from Jaypee Institute of Information Technology noida sector 62<eof>
...
[14:37] <anupamas> hello! i am Anupama Shipurkar. I am 12th passed out from science stream and looking forward to pursue engineering.<eof>
[14:37] <kushal> next
...
[14:38] <vikram> Hey! I am Vikram Singh , B.tech 1st year Computer Engineering undergrad from Zakir Hussain College of Engineering and Technology, Aligarh Muslim University.
[14:38] <sayan> next
[14:38] <kushal> vikram, means we have at least 3 people from your colleg3e
[14:38] <sayan> next
[14:38] <kushal> * college
[14:38] <kushal> next
[14:38] <zebak_> Hey! I am Zeba Karin, a 1st year student of Electronics Engineering at Zakir Hussain College of Engineering and Technology, Aligarh Muslim University. <eof>
[14:38] <mdbk_> Hello, I'm Onyinye Madubuko, I started learning programming few months ago, learnt about dgplug from a friend
...
[14:39] <sayan> next
[14:39] <kushal> next
[14:39] <ishank_g> Hi.. I am Ishank Gupta,just completed my Btech(ECE) from Aligarh Muslim University, Aligarh,UP.<eof>
[14:39] <jiteshpabla> Hi, I am Jitesh Pabla (i know my username is very creative /s), and I study computer science engineering at JIIT noida. Looking forward to working with this community, as I get very lazy when it comes to working alone without accountability.
[14:39] <kushal> next
[14:39] <Padfoot7> Hi I am Mohd Omama. I am a 1st year B.Tech student from Zakir Husain college of Engineering & Technology(ZHCET) ,Aligarh Muslim Unversity (AMU), Aligarh.
[14:40] <kvy> !
[14:40] <kushal> Padfoot7, you guys are wining in the highest number of people from one college category this year :)
[14:40] <kushal> next
[14:40] <jasonbraganza> Howdy folks, Iâ€™m Jason,  38, devoted husband, newly balding, love reading, IT consultant to small businesses, from Mumbai, and looking to switch careers to programming <eom>
[14:40] <kushal> next
...
[14:41] <rimshakhan> Hello people! This is Rimsha Khan. B.tech 1st year Computer Engineering undergrad from Zakir Hussain College of Engineering and Technology, Aligarh Muslim University. Aligarh.
[14:41] <bhawana> hello everyone!! I m Bhawana Singh,CSE final year student at IP university.
[14:41] <kushal> next
[14:41] <kushal> rimshakhan, you also spoke early :)
[14:41] <kushal> next
[14:41] <nisha_> hello everyone ,I am  Nisha Rani  a economics  student.And completed my graduation this year.
...
[14:42] <kushal> * an
[14:42] <kushal> next
[14:42] <sayan> Hi, I am Sayan Chowdhury. I work as a Fedora Infrastructure Engineer in the Fedora Engineering Team. I work on quite some open source projects. I did my dgplug training in the summers of 2010 and I've been stuck here since then learning stuffs from you people. <eom>
[14:42] <rimshakhan>  kushal, oops! sorry! :p
[14:43] <kushal> next
[14:43] <fhackdroid> Hey my name is Farhaan Bukhsh, I have been here for about 2 years now. I love playing basketball and love to code. I have been contributing to pagure.io, and few other project under Fedora. I am a final year student in Bangalore. Really nice to see you all.<eom>
[14:43] <kushal> next
[14:43] <_bhargav> Hi, I'm Bhargav I've been working as a full stack develoepr in Bangalore since the last 2 years. I'm here to know and be a part of the community and to work on improving my network and system programming/design knowledge. <eof>
[14:43] <acetakwas> Tosin Animashaun (Nigeria) | Software Developer for a FinTech startup | First attended DgpLUG Summer Training in 2014. Learned Python, Mercurial, Flask amongst other tools which I use professionally today. <eom>
...
[14:43] <kushal> next
[14:43] <chandankumar> Hi, I am Chandan Kumar, I work as a software engineer in Red Hat on RDO and OpenStack Upstream projects. I am one of the organizer for Python Pune meetup group.
[14:44] <chandankumar> <eom>
[14:44] <kushal> next
[14:44] <kushal> next
[14:44] <proishan11[m]> Hii! I am Ishan . I am first year CSE undergraduate at Zakir Hussain College of Engineering and Technology.
[14:44] <dodococo> Hello #dgplug I'm Deepak studying second year Computer Science Engineering in University Visvesvaraya Engineering College, Bangalore. New to FOSS. A wannabe Arch Linux contributor. I got a question, is batul a bot?<eof>
[14:45] <kushal> next
[14:45] <bhavin192> dodococo, yes
[14:45] <LambaInsaan> Hello, I am Rhitik Bhatt, I took this training last year. I have been learning computer science by myself since the past one year. <eof>
[14:45] <rahuldecoded> !
[14:45] <kushal> next
[14:45] <mbtamuli12_> Hello, I am Mriyam Tamuli(Pune), I atteded dgplug last year, 2016. I have contributed a little to open source projects. Looking to help others and learn more in the process.<eof>
[14:45] <kushal> next
[14:45] <akshayg96[m]> Hi.. I am Akshay Gaikwad. Pursuing B.Tech. Computer science at Rajarambapu Institute of Technology, Islampur <eof>
[14:46] <sayan> next
[14:46] <kushal> akshayg96[m], We type only one . after a sentence in English, the extra one you typed are actually taken away from poor developers' laptops.
[14:46] <sayan> next
[14:46] <sharan_> Hey, I am Sharan, second year Math & CS undergrad from Birla Institute of Technology and Science-Pilani, Machine Learning and FOSS enthusiast. <eom>
[14:46] <kushal> next
[14:46] <BhaveshSGupta1> Hello #dgplug,
[14:46] <BhaveshSGupta1> Hi I am Bhavesh Gupta, Currently working as front-end developer in a company called Investis,
[14:46] <BhaveshSGupta1> <eof>
[14:46] <kushal> next
[14:46] <kushal> next
[14:47] <kushal> next
[14:47] <neer> Hello, I am Nishanta Sarma, pursuing my B.tech in IT from North-Eastern Hill University, Meghalaya, curently I am in 6th semester.<eom>
[14:47] <Gnovi_> !
[14:47] <kvy> my name is vipin,i belong to alwar city(rajasthan),i want to learn,and i do a lots of spelling mistakes :). <eof>
[14:47] <kushal> next
[14:47] <rahuldecoded> I'm Rahul currently in 3rd of my BTech. I'm pursuing BTech from UIT, Burdwan. <eom>
[14:47] <kushal> next
[14:47] <kushal> next
[14:47] <bhavin192> kvy, i or I ?
[14:48] <kushal> kvy, you wanted to know about the students, now you know them.
[14:48] <Gnovi_> Hello Everyone. I am a physics teacher from Belgaum. First attended dgplug program in 2014.
...
[14:48] <kushal> To the students of  Zakir Hussain College of Engineering and Technology, how come so many of you in this training? How did you come to know about this training?
...
[14:51] <ahole[m]> Hi! I am Kshithij Iyer, pursuing MSC at SICSR Pune. I am quite new to Foss. I belong to Vadodara, Gujarat. And I am comfortable with Python, R, HTML, JavaScript (a few libraries as well), Java.
[14:51] <kushal> cran-cg, hopefully someday we will be able to visit you in the college.
[14:51] <shivamA1> Rahul bajaj (my senior) told me about dgplug,i was waiting for this training since pycon pune.
...
[14:52] <kushal> I know there are many people who wants to learn everything and also very fast.
[14:52] <kushal> The first link to study for all of you: (read it after the session) http://norvig.com/21-days.html
[14:53] <kushal> And then, re-read it again.
[14:53] <Gnovi_> @kushal :)  just a person who is curious about everything. And inspired by #dgplug and selfless mentors like Kushal Das :)
[14:54] <kushal> Next:
...
[14:55] <kushal> next
[14:55] <apoorv> Everybody was talking about pycon and wanted to know about pycon delhi can anybody guide me?
[14:55] <apoorv> <eof>
[14:55] <kushal> apoorv, There is only PyCon India happening at Delhi, and PyDelhi conference.
...
[14:57] <kushal> Both the logs from mbuf are your homework, read them carefully and also go through the pdf presentations mentioned in the log.
[14:57] <apoorv> Okay
[14:57] <kvy> kushal : ok
[14:58] <jiteshpabla> !
[14:58] <kushal> apoorv, I found https://github.com/pythonindia/inpycon2017/blob/master/index.html
[14:58] <kushal> next
[14:58] <kushal> next
[14:58] <ashwanig> When any off-topic talk is going on the channel, should we also stay online then? And what does the messages with slashes / mean? like s/i/l <eof>
...
[15:00] <ndakota> ashwanig : Second part of your question = means (s) substitute (i) instead of (l)
[15:00] <kushal> dhairyya, batul received your message later than ashwanig
[15:00] <kushal> next
[15:00] <jiteshpabla> as clients make irc more readable
[15:00] <dhairyya> !
[15:00] <_bhargav> ashwanig: the slash commands are generally for intimating typos. The syntax comes from the linux `sed` command.
[15:00] <kushal> next
...
[15:01] <mbtamuli12_> jiteshpabla: Well, you can always use python to remove unnecessary lines from the logs. ;) Also, you'll get them here. https://dgplug.org/irclogs/
[15:01] <bhavin192> dhairyya, they are away, not online
[15:01] <sayan> and the logs are not? You can always add CSS to the logs, use Python to remove lines
[15:01] <_bhargav> ashwanig: s/linux/gnu <eof>
[15:02] <ashwanig> _bhargav: got it :)
[15:02] <kushal> next
[15:02] <bhavin192> dhairyya, you can right click and see the information, there you will see the away message
...
[15:03] <kushal> next
[15:03] <anwesha> Sorry for this out of turn introduction, hi I am Anwesha, a mom, who was busy helping her toddler girl in the pee, so missed the introduction.
[15:03] <tnsittpsif> !
...
[15:08] <kushal> next
[15:08] <kushal> next
[15:08] <_bhargav> my question was answered https://github.com/kushaldas/ircbot this is batul's code right?
...
[15:09] <singh123> is there any way to divide class timing in groups as we have to wait a lot.
...
[15:10] <kushal> singh123, We are learning in a group, and a group progresses based the slowest team-mate.
...
[15:12] <bhargav> i was out and missed my introduction. i am bhargav tamuli i have done ECE from GIMT, assam
...
[15:14] <avik> thanks!
[15:14] <shreyab25> I had net issues and missed my intro, i am shreya from cummins college pune
[15:14] <kvy> !
...
[15:16] <nisha_> !
[15:16] <im_mohsin> dodococo, both. I have been doing Competitve programming and now getting started OSS. i think depends alot on what you enjoy. Fo me Competitve programming is fun and addictive as i  learn lot of new Algorithms and Data structures during long contest<eom>
[15:16] <saptaks> dodococo: I think OSS gives you more exposure to know how real life softwares work. In competitive coding you do get to learn the basics and improve your logics. But in OSS you get to learn how actually things work.
[15:16] <saptaks> In OSS you will actually get a real life scenario.
[15:17] <saptaks> In competitive coding you might be presented with a scenario which you might never face.
[15:17] <Priyansh> I too missed my intro. Sorry!
[15:17] <kushal> Priyansh, type it out now.
[15:17] <im_mohsin> saptaks, true.. Competitve programming improves problem solving ability which might help in OSS :)
...
[15:18] <kushal> im_mohsin, Every time you type extra, it creates extra heat, which is bad for the planet Earth.
[15:18] <dodococo> Thank you, can i get started in both at the same time?
[15:18] <dodococo> !
[15:18] <dodococo> sorry
[15:18] <sayan> Both of them are required. Contributing to open source helps know technologies, tools and build real softwares
...
[15:20] <sayan> Competitive is good, but it should be more like learning algorithms, maths and how you can use them
[15:20] <kushal> next
...
[15:21] <shankarj67> Kvy, ISP is internet service provider, mobile Sim you are using for internet in most cases
[15:22] <sayan> because, if you don't know algorithms you might be try to solve a problem, and people might have already written good algorithm for those scenarios
[15:22] <kvy> don't confuse me
[15:22] <kvy> in
[15:22] <kvy> oss
[15:22] <kvy> <eof>
[15:22] <sayan> fhackdroid: that's my take :) Open Source & Algorithms
[15:22] <im_mohsin> Competitve programming involves solving programming problem in sites like Hackerrank, codechef and websites alike
[15:23] <kvy> ok
[15:23] <kushal> next
[15:23] <kushal> next
...
[15:23] <kushal> next
[15:24] <kushal> next
[15:24] <nisha_>  Kushal, how can i improve my computer knowledge because i does not know much about computer science.<eof>
...
[15:24] <shankarj67> kvy, open source software, which one is available online for developers to modify the codes and improve the performance of that software.
[15:25] <SpEcHiDeR> fhackdroid, why is it displaying like this: @freenode_fhackdroid:matrix.org instead of your nickname?
[15:25] <nisha_> Kushal and Sayan thak you.
[15:25] <kushal> nisha_, like you are not from Computer Science background, anwesha is from Legal background (she is a lawyer).
[15:25] <kushal> next
[15:25] <ahole[m]> Most of the problems under project Euler are mathematical problems how do you apply them in real life use cases ?
[15:25] <ahole[m]> <eom>
...
[15:26] <ahole[m]> <eom>
[15:26] <kushal> In one of the days we will learn about history of Free Software and other important parts.
...
[15:28] <shankarj67> kvy, codechef is online competetive programming platform to improve your coding and algorithm skills.
[15:28] <kushal> Kushal Das
[15:28] <sayan> ahole[m]: you really don't do that in day to day life, but while building architectures for a product you generally need these skills
...
[15:30] <wrik003> I got disconnected a few minutes ago. Did I miss anything? Is today's session over?
[15:30] <kushal> wrik003, read the channel topic please
[15:30] <neer> Nishanta Sarma
----END CLASS---- """

eachline_list = log.split("\n")         
eachline_list.remove(eachline_list[0])
length_eachline_list = len(eachline_list)
eachline_list.remove(eachline_list[length_eachline_list-1])
nick = []
dictionary_words = {}
dictionary_lines = {}
set_nick=[]
print("The different nicks present in the log are : ")
for line in eachline_list:
    each_word_list = line.split(" ")
    unique_nick_name = each_word_list[1].strip("<").strip(">")
    nick.append(unique_nick_name)
    set_nick = "\n".join(set(nick)) 
    if unique_nick_name  in dictionary_words:
        dictionary_words[unique_nick_name] = dictionary_words[unique_nick_name ] + len(each_word_list) - 2
        dictionary_lines[unique_nick_name] = dictionary_lines[unique_nick_name] + 1
    else:
        dictionary_words[unique_nick_name] = len(each_word_list) - 2
        dictionary_lines[unique_nick_name] = 1
for values in dictionary_words:
    print(values)
    print("   Words: ",dictionary_words[values],"   Lines: ",dictionary_lines[values])
